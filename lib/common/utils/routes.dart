...
import 'package:food_recipe_app/views/main/add_edit_food/pages/search_page.dart';
...
import 'package:food_recipe_app/views/main/add_edit_food/pages/add_food_screen.dart';
import 'package:food_recipe_app/views/main/add_edit_food/pages/edit_food_screen.dart';
...
import 'package:food_recipe_app/widget/full_screen_image/full_screen_widget.dart';
...
Widget foodDetailPage(FoodModel food) => FoodDetailPage(food: food);
...
Widget deleteUser(String loginMethod) => DeleteUserScreen(loginMethod: loginMethod);
